...
class ElasticSearch {
    public:
        ...
        bool getDocument(const char* index, const char* type, const char* id, es_json::Object& msg);

        /// Request the document by index/type/ query key:value.
        void getDocument(const std::string& index, const std::string& type, const std::string& key, const std::string& value, es_json::Object& msg);
        ...
        /// Index a document.
        bool index(const std::string& index, const std::string& type, const std::string& id, const es_json::Object& jData);

        /// Index a document with automatic id creation
        std::string index(const std::string& index, const std::string& type, const es_json::Object& jData);
        ...
        bool update(const std::string& index, const std::string& type, const std::string& id, const es_json::Object& jData);

        /// Update or insert if the document does not already exists.
        bool upsert(const std::string& index, const std::string& type, const std::string& id, const es_json::Object& jData);

        /// Search API of ES. Specify the doc type.
        long search(const std::string& index, const std::string& type, const std::string& query, es_json::Object& result);

        /// Search API of ES. Specify the doc type.
        bool remove(const std::string& index, const std::string& type, const std::string& query, es_json::Object& result);

        // Bulk API
        bool bulk(const char*, es_json::Object& jResult);
    ...
    public:
        ...
        bool scrollNext(std::string& scrollId, es_json::Array& resultArray);
        ...
        int fullScan(const std::string& index, const std::string& type, const std::string& query, es_json::Array& resultArray, int scrollSize = 1000);

    private:
        void appendHitsToArray(const es_json::Object& msg, es_json::Array& resultArray);
...
class BulkBuilder {
	private:
		std::vector<es_json::Object> operations;

		void createCommand(const std::string &op, const std::string &index, const std::string &type, const std::string &id);

	public:
		BulkBuilder();
		void index(const std::string &index, const std::string &type, const std::string &id, const es_json::Object &fields);
		void create(const std::string &index, const std::string &type, const std::string &id, const es_json::Object &fields);
		void index(const std::string &index, const std::string &type, const es_json::Object &fields);
		void create(const std::string &index, const std::string &type, const es_json::Object &fields);
		void update(const std::string &index, const std::string &type, const std::string &id, const es_json::Object &body);
        void update_doc(const std::string &index, const std::string &type, const std::string &id, const es_json::Object &fields, bool update = false);
		void del(const std::string &index, const std::string &type, const std::string &id);
		void upsert(const std::string &index, const std::string &type, const std::string &id, const es_json::Object &fields);
		void clear();
		std::string str();
		bool isEmpty();
};
